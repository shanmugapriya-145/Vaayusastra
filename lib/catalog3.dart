...
class Catalog3DetailPage extends StatefulWidget {
  @override
  _Catalog3DetailPageState createState() => _Catalog3DetailPageState();
}

class _Catalog3DetailPageState extends State<Catalog3DetailPage> {
  ...
  void _provideBotResponse(String message) {
    ...
    if (message.toLowerCase().contains('payment')) {
      ...
      response = 'We offer courses in Business Administration, Entrepreneurship, and Digital Marketing.';
