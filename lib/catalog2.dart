...
class Catalog2DetailPage extends StatefulWidget {
  @override
  _Catalog2DetailPageState createState() => _Catalog2DetailPageState();
}

class _Catalog2DetailPageState extends State<Catalog2DetailPage> {
  ...
  void _provideBotResponse(String message) {
    ...
    if (message.toLowerCase().contains('payment')) {
      ...
      response = 'We offer courses in Software Engineering, Web Development, and Mobile App Development.';
